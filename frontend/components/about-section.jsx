...
export function AboutSection() {
  return (
    <section id="about" className="scroll-mt-20 py-20 bg-white border-b border-slate-200 font-poppins">
      <div className="mx-auto max-w-[1440px] px-6 sm:px-8 lg:px-10 space-y-16">
        ...
        <div className="pt-10 border-t border-slate-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 space-y-3">
              <div className="h-12 w-12 rounded-xl bg-teal-50 flex items-center justify-center text-[#0F766E] border border-teal-200">
                <Cpu className="h-6 w-6" />
              </div>
              <h4 className="font-serif text-base font-bold text-slate-900">3D Precision Tech</h4>
            ...
            <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 space-y-3">
              ...
              <h4 className="font-serif text-base font-bold text-slate-900">Direct Billing</h4>
              <p className="font-poppins text-xs text-slate-600 leading-relaxed">
            ...
            <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 space-y-3">
              ...
              <h4 className="font-serif text-base font-bold text-slate-900">DDS Specialists</h4>
              <p className="font-poppins text-xs text-slate-600 leading-relaxed">
            ...
            <div className="bg-slate-50/70 rounded-2xl p-6 border border-slate-200 space-y-3">
              ...
              <h4 className="font-serif text-base font-bold text-slate-900">Gentle Sedation</h4>
              <p className="font-poppins text-xs text-slate-600 leading-relaxed">
