...
export function CTABanner({ onOpenBooking }) {
  return (
    <section className="bg-[#0F766E] text-white py-20 relative overflow-hidden">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 relative z-10 text-center space-y-8">
        ...
        <div className="flex flex-wrap items-center justify-center gap-4 pt-2">
          <button
            ...
            className="bg-white text-[#0F766E] hover:bg-teal-50 rounded-full px-8 py-4 font-poppins text-xs font-bold uppercase tracking-wider flex items-center space-x-3 shadow-lg transition-all hover:scale-105 cursor-pointer"
          >
          ...
          <a
            href="tel:1800336825"
            className="bg-[#115E59] hover:bg-[#134E4A] text-white border border-teal-400/30 rounded-full px-7 py-4 font-poppins text-xs font-bold uppercase tracking-wider flex items-center space-x-2 transition-all hover:scale-105"
          >
        ...
        <div className="pt-6 border-t border-teal-600/60 flex flex-wrap items-center justify-center gap-8 font-poppins text-xs font-semibold tracking-wider text-teal-100">
