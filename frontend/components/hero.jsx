        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-center">
          <div className="lg:col-span-7 space-y-4 text-left">
            ...
            <h1 className="font-heading text-3xl sm:text-4xl lg:text-5xl font-extrabold tracking-tight text-[#111827] leading-tight">
              {t("heroTitlePrefix")} <span className="text-[#0F766E]">{t("heroTitleSuffix")}</span>
            </h1>
              ...
              <CardContent className="p-5 space-y-3">
                ...
                <div className="rounded-lg bg-[#F8FAFC] p-3 border border-[#E5E7EB] text-xs text-[#6B7280] space-y-1">
                  ...
                  <div className="flex gap-2 pt-1">
                    ...
                    <span className="bg-white px-2.5 py-1 rounded border border-[#E5E7EB] text-[#111827] font-semibold text-[11px]">02:15 PM</span>
                    <span className="bg-white px-2.5 py-1 rounded border border-[#E5E7EB] text-[#111827] font-semibold text-[11px]">04:45 PM</span>
                  </div>
                </div>
